...
class Attack:
    def __init__(self, owner_collider: Collider, damage: float, duration: float, direction: int, offset: int = 15, isRanged: bool = False, velocity: int = 0, collider: Collider = None) -> None:
